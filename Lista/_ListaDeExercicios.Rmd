...
# Por isso é necessário informar esses valores no parâmetro na.strings na hora de ler o arquivo. Como o csv contém dados entre aspas, por precaução
# vamos considerar também as strings "-1" e "-3"
...
O dataframe cand contém `r nrow(cand)` linhas e `r ncol(cand)` colunas referentes ao primeiro turno das eleições.
...
A tabela abaixo apresenta o quantitativo dos candidatos dos estados de Alagoas, São Paulo e Paraná por raça:
...
Não está claro o que significa "entre 20 e 50 anos". Em português podemos considerar isso como inclusivo (20 <= IDADE <= 50) ou exclusivo (20 < IDADE < 50). Vamos considerar que o enunciado deseja o cálculo incluindo as idades de 20 e 50 anos.
...
As respostas são exibidas no gráfico. Para 20 e 50 anos é a área hachurada. Para menos de 40 anos, é a área branca. Para acima de 60 anos, é a área hachurada. Para facilitar a visualização, o console mostra o resultado calculado com a função pnorm.
